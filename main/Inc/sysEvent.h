...
#define COLLECT_DEV_BATTERY_TEMP_CALIB_EVENT_BIT    (1<<6)        //电池温度校准设置
#define COLLECT_DEV_ENV_INFO_CALIB_EVENT_BIT        (1<<7)        //温湿度传感器校准设置
#define COLLECT_DEV_H2_MAP_SET_EVENT_BIT            (1<<8)        //校准H2传感器MAP设置
